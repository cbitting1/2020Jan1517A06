...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <div class="page-header">
    ...
    <asp:RequiredFieldValidator ID="RequiredProductName" runat="server" ErrorMessage="Product Name is requried" Display="None" SetFocusOnError="true" ForeColor="Firebrick" ControlToValidate="ProductName">
    </asp:RequiredFieldValidator>
   <div class="row">
       <div class="col-md-12">
           <asp:ValidationSummary ID="ValidationSummary1" runat="server" HeaderText="Please address the following concerns with your data:"/>
       </div>
   </div>
      <%--  this will be the lookup control area--%>
         <div class="col-md-12"> 
             ...
             <asp:LinkButton ID="RemoveProduct" runat="server" Font-Size="X-Large" CausesValidation="false" OnClick="RemoveProduct_Click" OnClientClick="return confirm('Are you sure you wish to discontinue this product?')">Remove</asp:LinkButton>&nbsp;&nbsp;
      ...
      <%--  this will be the entity CRUD area--%>
        <div class ="row">
            ...
            <div class="col-md-6 ">
                ...
                <asp:DropDownList ID="SupplierList" runat="server" Width="350px" DataSourceID="SupplerListODS" DataTextField="CompanyName" DataValueField="SupplierID" AppendDataBoundItems ="true">
    ...
    <asp:ObjectDataSource ID="SupplerListODS" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Suppliers_List" TypeName="NorthwindSystem.BLL.SupplierController">
