      ...
      <%--  this will be the entity CRUD area--%>
        <div class ="row">
            ...
            <div class="col-md-6 ">
                ...
                <asp:DropDownList ID="SupplierList" runat="server" Width="350px" ></asp:DropDownList><br />
                <asp:DropDownList ID="CategoryList" runat="server"  Width="350px"></asp:DropDownList><br />
