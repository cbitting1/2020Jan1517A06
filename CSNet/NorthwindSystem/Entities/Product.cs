...
namespace NorthwindSystem.Entities
{
    ...
    public class Product
    {
        ...
        //            --> Compute attribute is a sql computed attribute which means that NO actual data is stored in the sql table, it is generated by the expression in the sql table.
        ...
        [Range(0.00, int.MaxValue, ErrorMessage = "Unit Price is 0.00 or greater dollars. ")]
        public decimal? UnitPrice { get; set; } //Decimal for money


        [Range(0, 32767, ErrorMessage = "Unit in Stock is must be greater than 0. ")] //32767 is for small int (small int is int16)
        public Int16? UnitsInStock { get; set; } //int16 is for an small int
